...
import com.krieger.warehousemanagement.dto.ErrorDetails;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> manageWarehouseException(WarehouseManagementException exception, WebRequest webRequest){
        ErrorDetails errorDetails = new ErrorDetails(new Date(), exception.getMessage(), webRequest.getDescription(false));
